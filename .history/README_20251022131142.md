...
PART ONE (21/10/2025)
Creating the Laravel application. Creating models, migrations and controllers for the 4 entities. Accounts, Users, Transfers and Transactions. Working on database connectivity and for ease of my learning I will just use my Xampp (MySQL Admin)
