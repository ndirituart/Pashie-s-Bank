...
return new class extends Migration
{
    ...
    public function up(): void
    {
     ...
     Schema::create('transfers', function (Blueprint $table) {
               $table->id();
               $table->foreignId('sender_id')->nullable()->constrained('users')->onDelete('nullOnDelete');
               $table->foreignId('sender_account_id')->nullable()->constrained('accounts')->onDelete('nullOnDelete');
